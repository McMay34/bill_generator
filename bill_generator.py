...
def pdf_zeichnen_saven(daten):
    ...
    pdf.drawString(22*mm, 249*mm, "TripleConsult GmbH, Altersbacher Weg 19, 98587 Steinbach-Hallenberg")
    pdf.setFontSize(10)
    ...
    pdf.drawString(142*mm, 230*mm, '+49 179 9739344')
    pdf.drawString(142*mm, 226*mm, '+49 36847 539779')
    pdf.drawString(142*mm, 222*mm, 'info@tripleconsult.de')
    ...
    pdf.drawString(24*mm, 25*mm, "TripleConsult GmbH")
    pdf.drawString(24*mm, 21*mm, "Altersbacher Weg 19")
    pdf.drawString(24*mm, 17*mm, "98587 Steinbach Hallenberg")
    pdf.drawString(80*mm, 25*mm, "Geschäftsführung: Benjamin Jacob,")
    pdf.drawString(80*mm, 21*mm, "Friedrich Holland-Moritz")
    pdf.drawString(80*mm, 17*mm, "Amtsgericht Jena HRB 517001")
    pdf.drawString(80*mm, 13*mm, "USt-IdNr: DE331336896")
    pdf.drawString(128*mm, 25*mm, "Flessabank Schweinfurt")
    pdf.drawString(128*mm, 21*mm, "IBAN: DE39 7933 0111 0002 3407 89")
    pdf.drawString(128*mm, 17*mm, "BIC: FLESDEMXXX")
